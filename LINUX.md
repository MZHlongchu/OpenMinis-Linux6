...
启动器名称是 **Minis Ultra**，`applicationId` 为 `com.openminis.linux`。当前版本 **1.36.6-linux**（versionCode 59）。
...
正式发行包：[Releases `1.36.6-linux`](https://github.com/tall-1997/OpenMinis-Linux/releases/tag/1.36.6-linux)。1.36.6：聊天生图，以及豆包/智谱/DashScope/MiniMax 等专用生图生视频协议。详见 [docs/RELEASE-NOTES.zh.md](docs/RELEASE-NOTES.zh.md)。
