...
启动器名称是 **Minis Ultra**，`applicationId` 为 `com.openminis.linux`。当前版本 **1.36.5-linux**（versionCode 58）。
...
正式发行包：[Releases `1.36.5-linux`](https://github.com/tall-1997/OpenMinis-Linux/releases/tag/1.36.5-linux)。1.36.5：浏览器底栏、检查更新说明、自定义网页搜索。详见 [docs/RELEASE-NOTES.zh.md](docs/RELEASE-NOTES.zh.md)。
